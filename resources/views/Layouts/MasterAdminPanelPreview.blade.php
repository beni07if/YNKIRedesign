...
<body>
    ...
    @include('Layouts.SidebarAdminPanelPreview')
                            ...
                            <div class="card top-selling">
                                ...
                                <div class="card-body pb-0">
                                    ...
                                    <table class="table table-borderless">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th scope="row"><a href="#"><img src="{{asset('assetAdmin/img/product-1.jpt')}}" alt=""></a></th>
                                            ...
                                            <tr>
                                                <th scope="row"><a href="#"><img src="{{asset('assetAdmin/img/product-2.jpt')}}" alt=""></a></th>
                                            ...
                                            <tr>
                                                <th scope="row"><a href="#"><img src="{{asset('assetAdmin/img/product-3.jpt')}}" alt=""></a></th>
                                            ...
                                            <tr>
                                                <th scope="row"><a href="#"><img src="{{asset('assetAdmin/img/product-4.jpt')}}" alt=""></a></th>
                                            ...
                                            <tr>
                                                <th scope="row"><a href="#"><img src="{{asset('assetAdmin/img/product-5.jpt')}}" alt=""></a></th>
                        ...
                        <div class="card-body pb-0">
                            ...
                            <div class="news">
                                <div class="post-item clearfix">
                                    <img src="{{asset('assetAdmin/img/news-1.jpt')}}" alt="">
                                    <h4><a href="#">Nihil blanditiis at in nihil autem</a></h4>
                                    <p>Sit recusandae non aspernatur laboriosam. Quia enim eligendi sed ut harum...</p>
                                </div>

                                <div class="post-item clearfix">
                                    <img src="{{asset('assetAdmin/img/news-2.jpt')}}" alt="">
                                    <h4><a href="#">Quidem autem et impedit</a></h4>
                                    <p>Illo nemo neque maiores vitae officiis cum eum turos elan dries werona nande...</p>
                                </div>

                                <div class="post-item clearfix">
                                    <img src="{{asset('assetAdmin/img/news-3.jpt')}}" alt="">
                                    <h4><a href="#">Id quia et et ut maxime similique occaecati ut</a></h4>
                                    <p>Fugiat voluptas vero eaque accusantium eos. Consequuntur sed ipsam et totam...</p>
                                </div>

                                <div class="post-item clearfix">
                                    <img src="{{asset('assetAdmin/img/news-4.jpt')}}" alt="">
                                    <h4><a href="#">Laborum corporis quo dara net para</a></h4>
                                    <p>Qui enim quia optio. Eligendi aut asperiores enim repellendusvel rerum cuder...</p>
                                </div>

                                <div class="post-item clearfix">
                                    <img src="{{asset('assetAdmin/img/news-5.jpt')}}" alt="">
