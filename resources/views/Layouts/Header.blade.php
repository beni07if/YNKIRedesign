  ...
  <header id="header" class="fixed-top ">
      <div class="container d-flex align-items-center">
          ...
          <!-- <a href="{{route('index')}}" class="logo me-auto"><img src="assets/img/logo-ynki/logo-ynki.png" style="width:250px; height:50px;" alt="" class="img-fluid"></a> -->
          <a href="{{route('index')}}" class="logo me-auto"><img src="public/assets/img/logo-ynki/logo-ynki-terbaru.png" alt="" class="img-fluid"></a>
