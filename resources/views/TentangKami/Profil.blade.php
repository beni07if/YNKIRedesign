    ...
    <div class="container-fluid" data-aos="fade-up">
        ...
        <div class="row">
            ...
            <div class="col-lg-7 d-flex flex-column justify-content-center align-items-stretch  order-2 order-lg-1">
                ...
                <div class="content">
                    <h3><strong>YNKI</strong> Natural Kapital Foundation, Indonesia - Civil Society Organization - Democracy for Nature - bekerja untuk Visi Kesejahteraa Masyarakat dan Pembangunan Berkelanjutan </h3>
                    <p>
