    ...
    <div class="container-fluid" data-aos="fade-up">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 align-items-stretch order-1 order-lg-2 img">
                ...
                <iframe src="https://arcgis.com/apps/dashboards/5aecfd28de7746e481e3e800596fdc30" style="padding-top: 40px;" frameborder="0" style="border:0" allowfullscreen>iFrames are not supported on this page.</iframe>
                <!-- end maps dashboard  -->
                <br>
